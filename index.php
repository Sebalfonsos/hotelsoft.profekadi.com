...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><img style="height: 250%;" src="assets/img/navbar-logo.svg" alt="..." /></a>
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Bienvenido a HotelSOFT</div>
                <div class="masthead-heading text-uppercase">Su hogar fuera de casa</div>
                <a class="btn btn-primary btn-xl text-uppercase" href="login.php">Iniciar Sesión</a>
            </div>
        </header>
        <!-- Services-->
        ...
        <section class="page-section bg-light" id="team">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Ingenieros de Sistemas</h3>
                </div>
                <div class="row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="assets/img/team/Cristian Brieva.jpg" alt="..." />
